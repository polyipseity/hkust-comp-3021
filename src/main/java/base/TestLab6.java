...
public class TestLab6 {
	public static void main(String[] args) {
		...
		nb.createNote("Java", "course information",
				"Introduction to Java Programming. Fundamentals include language syntax, object-oriented programming, inheritance, interface, polymorphism, exception handling, multithreading and lambdas.");
		nb.createNote("Lab", "Lab requirement",
		...
		nb.createNote("Java", "marking scheme",
				"The quizzes and lab grades will be given based on your attendance in quizzes and lab, respectively.");
		...
		nb.createNote("Assignment", "Submission",
				"through Canvas. Compress only the src folder in the project directory as a zip file. Also, provide your Github repository link on the Canvas submission comment, as mentioned in lab assignments.");
